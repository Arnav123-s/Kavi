...
Current direction: [physical pathway mechanisms](PHYSICAL_PATHWAY_RESEARCH.md) studies internal heat/cooling, catalytic context and typed reaction rules, with separate engineered and learned-mechanism tracks. It seeks useful internal computation rather than hardware parity; all mechanisms remain proposals.
