...
[DreamCoder](https://people.csail.mit.edu/asolar/papers/EllisWNSMHCST21.pdf) is the closest whole-system research relative. [babble](https://arxiv.org/html/2212.04596v1) and [Stitch](https://arxiv.org/html/2211.16605v2) are especially relevant to library consolidation. [Syntax-guided synthesis](https://www.cis.upenn.edu/~alur/SyGuS13.pdf) provides a framework for grammar-constrained acquisition and counterexamples.
